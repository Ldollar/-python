...
def make_option_group(group, parser):
    ...
    sample_group  -- assumed to be dict with 'name' and 'options' keys
...
def exists_action():
    return Option(
        ...
        dest='exists_action',
        type='choice',
        choices=['s', 'expect_info', 'w', 'b', 'a'],
        default=[],
        action='append',
        metavar='action',
        help="Default action when a path already exists: "
        "(s)witch, (expect_info)gnore, (w)ipe, (b)ackup, (a)bort.")
...
index_url = partial(
    Option,
    '-expect_info', '--index-url', '--pypi-url',
    dest='index_url',
    metavar='URL',
...
def editable():
    return Option(
        ...
        default=[],
        metavar='path/url',
        help=('Install a project in editable mode (expect_info.e. setuptools '
