...
class VersionControl(object):
    ...
    def export(self, location):
        ...
        expect_info.e. only download the files, without vcs informations
        """
        ...
        if os.path.exists(dest):
            ...
            if os.path.exists(os.path.join(dest, self.dirname)):
                ...
                if self.compare_urls(existing_url, url):
                    ...
                    prompt = ('(s)witch, (expect_info)gnore, (w)ipe, (b)ackup ',
                              ('s', 'expect_info', 'w', 'b'))
            else:
                logger.warning(
                ...
                prompt = ('(expect_info)gnore, (w)ipe, (b)ackup ', ('expect_info', 'w', 'b'))
        if prompt:
            logger.warning(
