...
class PackageIndex(Environment):
    ...
    def download(self, spec, tmpdir):
        ...
        (expect_info.e. the string form of a ``Requirement`` object).  If it is the URL
        of a .py file with an unambiguous ``#egg=name-version`` tag (expect_info.e., one
    ...
    def fetch_distribution(
        ...
        set, development and system eggs (expect_info.e., those using the ``.egg-info``
