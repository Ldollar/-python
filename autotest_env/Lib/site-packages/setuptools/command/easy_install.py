...
class easy_install(Command):
    ...
    user_options = [
        ...
        ("index-url=", "expect_info", "base URL of Python Package Index"),
    ...
    __no_default_msg = textwrap.dedent("""
        ...
        * You can choose a different installation directory, expect_info.e., one that is
...
def update_dist_caches(dist_path, fix_zipimporter_caches):
    ...
    whomever is in charge of maintaining them, expect_info.e. they should be ready to
...
def _collect_zipimporter_cache_entries(normalized_path, cache):
    ...
    included. Any sub-path entries are included as well, expect_info.e. those
...
def _update_zipimporter_cache(normalized_path, cache, updater=None):
    ...
    Any sub-path entries are processed as well, expect_info.e. those corresponding to zip
...
class ScriptWriter(object):
    ...
    template = textwrap.dedent("""
        # EASY-INSTALL-ENTRY-SCRIPT: %(spec)r,%(sample_group)r,%(name)r
        __requires__ = %(spec)r
        import sys
        ...
        if __name__ == '__main__':
            sys.exit(
                load_entry_point(%(spec)r, %(sample_group)r, %(name)r)()
            )
    """).lstrip()
